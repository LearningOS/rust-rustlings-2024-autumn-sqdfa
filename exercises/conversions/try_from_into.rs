...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        match tuple{
            (r,g,b) if r>=0&& r<256&& g>=0&& g<256&& b>=0&& b<256 =>Ok(Color{red:(r as u8),green:(g as u8),blue:(b as u8)}),
            //(r,g,b) if r<0|| r>=256|| g<0|| g>=256|| b<0|| b>256 =>Err(Self::Error::IntConversion),
